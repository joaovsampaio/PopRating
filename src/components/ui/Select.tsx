...
const SelectCategory = ({ setSelectCategory }: Props) => {
  ...
  return (
    ...
    >
      <Select.Trigger
        className="inline-flex items-center justify-center rounded px-[15px] leading-none h-[35px] gap-[5px] bg-neutral-100 text-neutral-900 border border-primary-500 shadow-[0_2px_10px] shadow-neutral-900/10 hover:bg-neutral-200 focus:shadow-[0_0_0_2px] focus:shadow-neutral-900 data-[placeholder]:text-neutral-900 outline-none"
